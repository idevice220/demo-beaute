      ...
      <div className="relative mx-auto grid max-w-5xl gap-10 lg:grid-cols-[1fr_440px] lg:items-center lg:py-16">
        <div>
          ...
          <ul className="mt-6 space-y-2.5 text-[15px] text-ink/80">
            ...
            <li className="flex items-start gap-2.5"><ShieldCheck size={17} className="mt-0.5 shrink-0 text-terra" /> Tout ce que vous modifiez est visible sur le site immédiatement.</li>
            <li className="flex items-start gap-2.5"><RotateCcw size={17} className="mt-0.5 shrink-0 text-terra" /> Les données reviennent à l’état initial toutes les 2 heures.</li>
          </ul>
        </div>
